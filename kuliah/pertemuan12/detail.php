    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="keterangan">
          ...
          <a href="ubah.php?id=<?= $mhs['id']; ?>" class="btn btn-primary mt-2">Ubah</a>
          <a href="hapus.php?id=<?= $mhs['id']; ?>" class="btn btn-danger mt-2" onclick="return confirm ('apakah anda yakin?');">Hapus</a><br>
